<nav class="position-fixed pull-top parent-width short-medium display-flex align-items-center justify-space-between text-light background-dark z-index-100">
  <a href="/">
    <div class="short-small margin-horizontal-large">
      <svg class="parent-height" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 102 102" fill="currentColor">
  ...
  <nav class="margin-horizontal-large display-flex gap-medium">
    <a class="text-light-lighten" href="/docs">
      <div class="padding-medium">Documentation</div>
    </a>
    <a class="text-light-lighten" href="/components">
      <div class="padding-medium">Components</div>
    </a>
    <a class="text-light-lighten" href="/themes">
