export const sections = [
  {
    ...
    slug: "html",
    shortDescription: "A comprehensive HTML reference guide showcasing Elevon's base styling on semantic HTML elements",
    description: "Elevon design system is built upon HTML as its foundational technology to create modern, responsive, and accessible user interfaces. This comprehensive HTML reference guide is specifically tailored to showcase how Elevon's base styling looks and feels on semantic HTML elements, without the use of any additional helper classes.",
  }, {
    title: "CSS Reference",
    slug: "css",
    shortDescription: "A complete CSS reference guide showcasing Elevon design system's usage of all CSS properties",
    description: "Elevon design system leverages the power of CSS to create modern and responsive user interfaces. This comprehensive CSS reference guide provides developers with a complete reference of all CSS properties and their usage in the Elevon design system."
  }
];