<script>
  ...
  let item = data.item
  let itemDesc = `Axess ${item.desc} reference.`
</script>

<svelte:head>
	<title>{item.tag} - Tags - Axess</title>
	<meta property="og:title" content="{item.tag} - Tags - Axess" />
...
<p class="margin-top-small padding-all-medium background-dark">{itemDesc}</p>
